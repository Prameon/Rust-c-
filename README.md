...
Метод - это таже функция, которая уже имеет реализацию для конкретного типа. Другими словами другой програмист уже написал весь код за вас, нам только нужно вызвать метод и подставить аргументы которые принимает метод, и получить результат.

Используя методы, мы используем Стандартную библиотеку Rust.

[i8](https://doc.rust-lang.org/std/primitive.i8.html)
[i16](https://doc.rust-lang.org/std/primitive.i16.html)
[i32](https://doc.rust-lang.org/std/primitive.i32.html#method.pow)
...
/*(5 в степении 2 ровно 25. т.е. 5*5.)*/
...
во втором примере мы создаем переменую `a` (объект) и задаем тип `i32`, чтобы компилятор мог сам найти методы типа `i32`.
так как мы позиционируем переменую как измениение объекта, то запись `a.pow(b)`.
